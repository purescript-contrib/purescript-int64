...
export const negOne   = NEG_ONE;
export const uzero    = UZERO;
export const uone     = UONE;
export const maxValue = MAX_VALUE;
export const maxUnsignedValue = MAX_UNSIGNED_VALUE;
export const minValue = MIN_VALUE;

// Utilities
export const isLong_ = Long.isLong;
export const fromBits_ = Long.fromBits;
export const fromBytes_ = Long.fromBytes;
export const fromBytesLE_ = Long.fromBytesLE;
export const fromBytesBE_ = Long.fromBytesBE;
export const fromInt_ = Long.fromInt;
export const fromNumber_ = Long.fromNumber;
export const fromString_ = Long.fromString;
export const fromValue_ = Long.fromValue;
...
/* What follow is a literal copy-paste of
 * https://github.com/dcodeIO/long.js/blob/088e44e5e3343ef967698565678384fa474b003b/index.js
 */
